...
import ua.edu.sumdu.library.ui.viewmodels.MovieDetailsUiState
import ua.edu.sumdu.library.ui.viewmodels.MovieViewModel
import ua.edu.sumdu.library.ui.viewmodels.toMovie
...
fun MovieDetailsScreenPreview() {
    MovieLibraryTheme {
        MovieDetailsBody(
            MovieDetailsUiState(
                movieDetails = ua.edu.sumdu.library.ui.viewmodels.MovieDetails(1, "Barby", "I`m barby girl")
            ),
            onDelete = {}
        )
    }
